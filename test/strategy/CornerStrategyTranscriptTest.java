...
/**
 * Test class for corner strategy that prints out the transcript of the inspected corners.
 */
public class CornerStrategyTranscriptTest {
  ...
  public void setUp() {
    ...
    aiPlayer.addCardToHand(new StandardCard("TestCard", Value.FIVE, Value.SIX, Value.FOUR,
            Value.FIVE));

    Player opponent = new PlayerImpl("Blue");
    opponent.addCardToHand(new StandardCard("OppCard", Value.THREE, Value.THREE, Value.THREE,
            Value.THREE));
  ...
  /**
   * Test class which executes a basic corner strategy search and records the corners inspected.
   *
